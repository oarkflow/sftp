...
[![Release](https://img.shields.io/github/v/release/fclairamb/ftpserverlib)](https://github.com/oarkflow/sftp/releases/latest)
[![Build](https://github.com/oarkflow/sftp/workflows/Build/badge.svg)](https://github.com/oarkflow/sftp/actions/workflows/build.yml)
...
[![GoDoc](https://godoc.org/github.com/oarkflow/sftp?status.svg)](https://godoc.org/github.com/oarkflow/sftp)
 ...
 * Uses only the standard library except for:
   ...
   * [fclairamb/go-log](https://github.com/oarkflow/sftp/log) for logging through your existing libraries [go-kit/log](https://github.com/go-kit/log), [log15](https://github.com/inconshreveable/log15), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog/), [logrus](https://github.com/sirupsen/logrus)
...
## The driver
The simplest way to get a good understanding of how the driver shall be implemented is to look at the [tests driver](https://github.com/oarkflow/sftp/blob/master/driver_test.go).
